  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--primary) / 0.55)", borderColor: "hsl(var(--primary) / 0.6)" },
          "50%": { boxShadow: "0 0 24px 4px hsl(var(--primary) / 0.45)", borderColor: "hsl(var(--primary) / 1)" },
        },
        "scan-line": {
