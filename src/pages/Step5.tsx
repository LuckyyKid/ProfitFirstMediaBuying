...
const translations = {
  en: {
    step: "STEP 5: BUSINESS DEEP DIVE",
    mainTitle: "Your business, in depth",
    description:
      "Help us understand your margins, stock, claims and creative approval workflow so we can push the right offers without wasting budget.",
    backButton: "Back to previous step",
  },
  fr: {
    step: "ÉTAPE 5 : BUSINESS DEEP DIVE",
    mainTitle: "Votre business, en profondeur",
    description:
      "Aidez-nous à comprendre vos marges, votre stock, vos claims et votre workflow d'approbation créatif pour pousser les bonnes offres sans gaspiller de budget.",
  ...
  return (
    <div className="min-h-screen relative overflow-hidden animate-fade-in">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <ProgressBar currentStep={5} language={language} />
          ...
          <div className="glass-card rounded-3xl p-6 md:p-10 space-y-8 glow-effect">
            ...
            {alreadyDone ? (
              ...
              <QuizSlideshow
                ...
                email={(progress as any)?.email ?? (info as any)?.lead?.email ?? null}
                brandName={(progress as any)?.brand_name ?? (info as any)?.client?.name ?? null}
