...
const ContractPage7 = ({ data }: Props) => {
  ...
  return (
    <div className={pageClassName} style={pageStyle}>
      <Section title="">
        {isEN ? (
          <>
            <p className="font-semibold">24.2 Right of refusal or suspension</p>
            <p>The Company reserves the right, at its sole reasonable discretion, to:</p>
            <ul className="list-disc ml-6 mt-1 space-y-1">
              <li>refuse to launch or maintain any campaign it considers non-compliant with applicable laws or with the policies of the advertising platforms;</li>
              <li>temporarily suspend campaigns in the event of serious doubt as to compliance;</li>
              <li>require any necessary documentary evidence demonstrating the Client's regulatory compliance.</li>
            </ul>
            <p className="mt-2">Such a suspension or refusal does not constitute a breach of the Contract by the Company.</p>

            <p className="font-semibold mt-4">24.3 Liability</p>
            <p>The Client remains solely responsible for the legal compliance of its products, services and marketing communications.</p>
            <p className="mt-2">The Company cannot be held liable for consequences resulting from:</p>
            <ul className="list-disc ml-6 mt-1 space-y-1">
              <li>Client non-compliance;</li>
              <li>a regulatory sanction;</li>
              <li>a suspension or restriction imposed by an advertising platform because of the content or sector of the Client's activity.</li>
            </ul>
          </>
        ) : (
          <>
      ...
      <Section title={isEN ? "25. Data and privacy" : "25. Données et vie privée"}>
        {isEN ? (
          <>
            <p className="font-semibold">25.1 Compliance with applicable laws</p>
            <p>The parties agree to comply with all applicable laws relating to the protection of personal information, including in particular the Personal Information Protection and Electronic Documents Act (PIPEDA) as well as any applicable provincial legislation, including Quebec's Law 25 where relevant.</p>
            <p className="mt-2">Each party remains responsible for the personal information it collects or processes as part of its own activities.</p>

            <p className="font-semibold mt-4">25.2 Ownership of data</p>
            <p>Subject to the rights of the advertising platforms (Meta, Google or others):</p>
            <ul className="list-disc ml-6 mt-1 space-y-1">
              <li>The data collected as part of the advertising campaigns, including lead data, forms, pixels and audiences, remains the property of the Client.</li>
              <li>The internal tools, methods, analyses, strategic models and systems developed by the Company remain the exclusive property of the Company.</li>
            </ul>

            <p className="font-semibold mt-4">25.3 Data incident or breach</p>
            <p>In the event of unauthorized access, loss, disclosure or breach of security of personal information related to the campaigns:</p>
            <ul className="list-disc ml-6 mt-1 space-y-1">
              <li>The responsible party must notify the other party within a maximum of forty-eight (48) hours of discovering the incident.</li>
              <li>It must reasonably cooperate to limit the impacts and enable compliance with the legal obligations to report to the competent authorities and to the persons concerned.</li>
            </ul>

            <p className="font-semibold mt-4">25.4 Retention and deletion</p>
            <p>Unless otherwise required by law:</p>
            <ul className="list-disc ml-6 mt-1 space-y-1">
              <li>Data related to the campaigns will be retained for a maximum period of twelve (12) months following termination of the Contract.</li>
              <li>After this period, the data may be deleted or anonymized.</li>
            </ul>
            <p className="mt-2">It is the Client's responsibility to back up or export its data before the retention period expires.</p>
          </>
        ) : (
          <>
